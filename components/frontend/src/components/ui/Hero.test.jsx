...
describe("Hero Component", () => {
  ...
  it("applies proper styling classes", () => {
    ...
    const container = screen
      .getByText("Discover Your Next Adventure")
      .closest(".layout-content-container");
  ...
  it("has background image styling", () => {
    ...
    const backgroundDiv = screen
      .getByText("Discover Your Next Adventure")
      .closest('[style*="background-image"]');
    expect(backgroundDiv).toBeTruthy();
    expect(backgroundDiv).toHaveStyle({
      backgroundImage: expect.stringContaining("googleusercontent.com"),
    });
  });
  ...
  it("applies container query classes correctly", () => {
    ...
    while (currentElement && !foundContainer) {
      if (
        ...
        currentElement.className.includes("@container")
      ) {
        foundContainer = true;
      }
