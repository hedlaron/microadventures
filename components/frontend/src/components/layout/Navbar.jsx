      ...
      <div className="w-full px-4 sm:px-6 lg:px-8">
        <header className="flex items-center justify-between py-3">
          ...
          <div className="flex items-center gap-9">
            <Link to="/about" className="text-[#0c1c17] text-sm font-medium leading-normal hover:text-[#F4A261] transition-colors">
              About
            </Link>
            <Link to="/contact" className="text-[#0c1c17] text-sm font-medium leading-normal hover:text-[#F4A261] transition-colors">
              Contact
            </Link>
            {isAuthenticated && (
              <Link to="/plan" className="text-[#0c1c17] text-sm font-medium leading-normal hover:text-[#F4A261] transition-colors">
                Plan
              </Link>
            )}
            {isAuthenticated && (
              <Link to="/history" className="text-[#0c1c17] text-sm font-medium leading-normal hover:text-[#F4A261] transition-colors">
                History
              </Link>
            )}
            {!isAuthenticated && (
