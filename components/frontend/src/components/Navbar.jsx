      ...
      <div className="w-full px-4 sm:px-6 lg:px-8">
        <header className="flex items-center justify-between py-3">
          ...
          <div className="flex items-center gap-8">
            ...
            {isAuthenticated && (
              <Link to="/history" className="text-[#0c1c17] text-base font-medium leading-normal hover:text-[#F4A261] transition-colors">
                History
              </Link>
            )}
            {!isAuthenticated && (
              <div className="inline-block mr-6">
                <button 
                  ...
                  className="inline-flex items-center justify-center px-6 py-2 text-sm font-semibold text-white bg-gradient-to-r from-[#F4A261] to-[#E76F51] hover:from-[#E76F51] hover:to-[#D84B40] transition-[background,box-shadow] duration-200 shadow-lg hover:shadow-xl border-0 rounded-xl focus:ring-4 focus:ring-orange-300/25"
                >
            ...
            {isAuthenticated && (
              <div className="relative" ref={dropdownRef}>
                ...
                >
                  ...
                  <span className="text-[#0c1c17] text-base font-medium">
                    {getUserName()}
                  </span>
                ...
                {isDropdownOpen && (
                  <div className="absolute right-0 bg-white rounded-xl border border-orange-200/50 z-[100] overflow-hidden mt-2 w-56">
                    <div className="bg-white border-b border-orange-200/50 p-4">
                      <div className="text-xs text-[#F4A261] uppercase tracking-wider mb-1">Signed in as</div>
                      <div className="text-sm font-semibold text-[#0c1c17]">{getUserName()}</div>
                    </div>
                    <button
                      onClick={handleLogout}
                      className="w-full text-left text-sm text-[#0c1c17] hover:bg-orange-50 hover:text-[#F4A261] transition-colors duration-200 flex items-center gap-3 p-4"
                    >
