...
describe('ContactBubble Component', () => {
  ...
  it('displays the welcome message', () => {
    render(<ContactBubble />)
    expect(screen.getByText("Love what you see? Let's build something amazing together!")).toBeInTheDocument()
  })
  ...
  it('displays LinkedIn connection link', () => {
    ...
    expect(linkedinLink).toHaveAttribute('href', 'https://linkedin.com/in/hedlaron')
  ...
  it('has gradient styling', () => {
    ...
    const bubbleContent = screen.getByText(/Love what you see/).closest('[class*="bg-gradient"]')
    expect(bubbleContent).toHaveClass('bg-gradient-to-br', 'from-green-400', 'to-emerald-500')
  })
  ...
  it('contains LinkedIn SVG icon', () => {
    ...
    const svgIcon = screen.getByRole('link', { name: /connect on linkedin/i }).querySelector('svg')
  ...
  it('has animation classes', () => {
    ...
    const container = screen.getByText(/Love what you see/).closest('.animate-bounce-once')
    expect(container).toHaveClass('animate-bounce-once')
    
    const bubbleContent = screen.getByText(/Love what you see/).closest('[class*="animate-fade-in"]')
