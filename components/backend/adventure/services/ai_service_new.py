...
def generate_adventure_recommendations(
    ...
    - Charming stories, local legends, or interesting historical tidbits
    - Beautiful views, photo spots, or aesthetically pleasing areas
    - Quirky architecture, street art, or creative installations
    - Local businesses with character, charm, or interesting backstories
    ...
    - Show how adventure is accessible without big planning or travel
    - Help them become a tourist in their own area
    - Create moments of joy, discovery, and pleasant surprises
    - Focus on things that are free or low-cost to experience
    - Make familiar places feel fresh and exciting
    
    📱 SPONTANEOUS ADVENTURE VIBES:
    - Easy to do right now without special preparation
    ...
    🖼️ IMAGE INSPIRATION:
    Create an image prompt that captures the joy and wonder of discovery - think golden hour lighting, interesting architecture, charming street scenes, nature in urban settings, or people enjoying unique local spots. The image should make viewers think "I want to go explore that place!"
    
    🌈 EXAMPLES OF DELIGHTFUL DISCOVERIES:
    - "This coffee shop is in a converted 1920s bank vault with original details"
    - "The murals on this block tell the story of the neighborhood's artistic renaissance"
    - "This hidden garden behind the library has the best sunset views in the area"
    - "The old theater still has original Art Deco features you can see from the street"
    - "This market has vendors who've been here for generations with amazing stories"
