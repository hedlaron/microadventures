...
def upgrade() -> None:
    ...
    op.add_column(
        "adventures", sa.Column("itinerary", sa.JSON(), nullable=False, server_default="[]")
    )
    op.add_column("adventures", sa.Column("route", sa.JSON(), nullable=False, server_default="{}"))
    op.add_column(
        "adventures", sa.Column("weather_forecast", sa.JSON(), nullable=False, server_default="{}")
    )
    op.add_column(
        "adventures", sa.Column("packing_list", sa.JSON(), nullable=False, server_default="{}")
    )
