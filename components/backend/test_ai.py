...
def main():
    ...
    try:
        ...
        print(f"First activity: {adventure['itinerary'][0]['time']} - {adventure['itinerary'][0]['activity']}")
        print(f"Weather: {adventure['weather_forecast']['temperature']} - {adventure['weather_forecast']['conditions']}")
